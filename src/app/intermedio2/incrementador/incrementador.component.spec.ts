...
describe('Componente incrementador', () => {
    ...
    it('Debe de mostar la leyenda y el progreso.', () => {
    ...
    it('Debe de incrementae/decrementar en 5, con un click en el botón', ()=>{
    ...
    it("En el titulo del componente debe de mostar el progreso ",()=>{
        const botones=fixture.debugElement.queryAll(By.css('.btn-primary'));
        botones[0].triggerEventHandler('click', null);
        fixture.detectChanges();
